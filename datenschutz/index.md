...
Unsere Website wird über GitHub Pages gehostet, einem Dienst der GitHub Inc., 88 Colin P. Kelly Jr. St., San Francisco, CA 94107, USA. In diesem Zusammenhang verarbeitet GitHub personenbezogene Daten (z. B. IP-Adresse, technische Metadaten) auch in den USA. Wir weisen darauf hin, dass nach Auffassung des Europäischen Gerichtshofs derzeit kein angemessenes Schutzniveau für den Datentransfer in die USA besteht. Dies kann mit Risiken für die Rechtmäßigkeit und Sicherheit der Datenverarbeitung einhergehen. Als Grundlage für Datenübermittlungen in Drittländer verwendet GitHub Standardvertragsklauseln gemäß Art. 46 DSGVO. Weitere Informationen: https://docs.github.com/de/site-policy/privacy-policies/github-general-privacy-statement

Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der zuverlässigen Bereitstellung und Sicherheit unserer Website). Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung zusätzlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG (z. B. für Cookies/vergleichbare Technologien). Die Einwilligung ist jederzeit widerrufbar.

### Hetzner (Sensoren-Seite)

Die Sensoren-Seite unter https://sensoren.makerspace-partheland.de wird bei Hetzner gehostet. Anbieter ist die Hetzner Online GmbH, Industriestr. 25, 91710 Gunzenhausen (nachfolgend Hetzner).
